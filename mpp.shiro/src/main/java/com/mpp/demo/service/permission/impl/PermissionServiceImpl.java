...
import com.mpp.demo.dao.UPermissionDao;
 ...
 */
@Service
public class PermissionServiceImpl extends BaseMybatisDao<UPermissionDao> implements PermissionService {
    @Autowired
    ...
    public Map<String, Object> deletePermissionById(String ids) {
        ...
        try {
            ...
            for (String idx : idArray) {
                ...
                List<URolePermission> rolePermissions = rolePermissionDao.findRolePermissionByPid(id);
